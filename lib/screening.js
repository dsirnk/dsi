...
var _           = require('lodash'),
    ...
    logStyle    = {
        ...
        'info'   : { fg: 'magenta', bold: true },
        'info2'  : { fg: 'blue',    bold: true },
    ...
    simulate    = {
                    ...
                    addclass   : function(q) {
                        if (q[1]) casper.evaluate(function(q) { $(q[0]).addClass(q[1]); }, q);
                        else logError('Error: expected format for addClass is addClass=selector|className');
                    },
                    addattr    : function(q) {
                        if (q[1] && q[2]) casper.evaluate(function(q) { $(q[0]).attr(q[1], q[2]); }, q);
...
Screenfly.prototype = {
    ...
    simulate: function () { for (var e in this._qs) simulate[e](this._qs[e]); },
    screenshot : function() {
        var $this = this;
...
casper.on('mouse.move', function(e) { log(e); });
